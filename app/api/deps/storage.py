...
#         redis_url = config.redis_config.connection_string
...
#             logger.warning("⚠️  Redis health check failed before yielding")
...
#         else:
#             logger.warning("⚠️  Redis startup check failed (will retry on first use)")
